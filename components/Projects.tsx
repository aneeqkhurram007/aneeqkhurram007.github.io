...
function Projects({}: Props) {
  const [projects, setprojects] = useState<Array<any>>([1, 2, 3, 4, 5]);
  return (
    <motion.div
          ...
          >
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="text-lg text-center md:text-left">
                ...
                doloremque ipsam. Quo suscipit architecto consectetur laborum
                aliquid quidem, natus impedit praesentium. Nisi perspiciatis
                libero possimus aspernatur saepe aut hic pariatur?
              </p>
            </div>
          </div>
        ))}
